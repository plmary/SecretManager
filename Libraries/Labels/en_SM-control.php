<?php
	$L_Title = "SecretManager install control";

	$L_Constants_File = "Constants file";
	...
	$L_SecretServer_Control = "SecretServer control";
	$L_SecretServer_Status = "SecretServer status";
?>